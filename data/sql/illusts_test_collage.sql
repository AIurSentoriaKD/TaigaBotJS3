...
CREATE TABLE `collage` (
  `illust_reference` varchar(11) COLLATE utf8mb4_bin NOT NULL,
  `image_link` varchar(300) COLLATE utf8mb4_bin NOT NULL,
  PRIMARY KEY (`illust_reference`),
  CONSTRAINT `collage_ibfk_1` FOREIGN KEY (`illust_reference`) REFERENCES `illusts` (`id`)
