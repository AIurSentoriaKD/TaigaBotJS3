...
CREATE TABLE `discord_user` (
  ...
  PRIMARY KEY (`id`),
  CONSTRAINT `discord_user_chk_1` CHECK ((`premium_status` in (_utf8mb4'on',_utf8mb4'off')))
...
INSERT INTO `discord_user` VALUES ('208678337646690307','off'),('245989710508457986','off'),('539302272534839296','off');
